...
CMD ulimit -n 1024; uwsgi --disable-logging --http-socket :$PORT --module wsgi  --gevent 512 --gevent-monkey-patch  --processes `expr 1 \+ 2 \* $(getconf _NPROCESSORS_ONLN)`  --listen 1024
