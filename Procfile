web: newrelic-admin run-program gunicorn -k gevent --threads $WORKER_CONCURRENCY --preload --worker-connections $WORKER_CONNECTIONS --timeout 31 --keep-alive 1 --backlog 2048 --log-syslog --log-syslog-prefix GUNICORN --log-level INFO app:application
